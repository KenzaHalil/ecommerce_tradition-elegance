...
def init_services(app):
    ...
    services = {
        ...
        # utilise l'instance order_svc créée plus haut (implémentation du domaine)
        "order": order_svc,
        # exposer la passerelle de paiement pour la route checkout
        "payment": gateway,
        # si tu veux un accès direct au delivery/billing ajoute les variables ici
    }
